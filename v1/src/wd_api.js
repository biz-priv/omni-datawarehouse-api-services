...
async function getDataFromDB() {
  try {
    ...
    case when b.order_status in ('PUP','DPO','AAP','AAD','COB','CEH','CCL','APD','DAR','DEL','OSD','REF') then b.event_date else null end as Event_Date_utc,
