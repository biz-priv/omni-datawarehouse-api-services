    ...
    start = """<?xml version="1.0" encoding="utf-8" ?><soap:Envelope \
        ...
        xmlns:xsd="http://www.w3.org/2001/XMLSchema" \
            xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"><soap:Header><AuthHeader xmlns="http://tempuri.org/"> \
                    <UserName>"""+ (temp_ship_data["AddNewShipmentV3"]["shipmentCreateRequest"]["WebTrakUserID"] if (customer_id == 'customer-portal-admin' and "WebTrakUserID" in temp_ship_data["AddNewShipmentV3"]["shipmentCreateRequest"])else os.environ["wt_soap_username"])+"""</UserName><Password>"""+os.environ["wt_soap_password"]+"""</Password>\
