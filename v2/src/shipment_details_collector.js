...
//   // const dataSet = await fetchDataFromTables(tableValues,orderNo);
//   // console.log("dataSet",dataSet)
//   //if(unmarshalledData.FK_ServiceLevelId )
...
//     fileNumber: get(
//       data,
//       `${process.env.SHIPMENT_HEADER_TABLE}[0].PK_OrderNo`,
//       null
//     ),
//     HouseBillNumber: get(
//       data,
//       `${process.env.SHIPMENT_HEADER_TABLE}[0].Housebill`,
//       null
//     ),
//     masterbill: get(
//       data,
//       `${process.env.SHIPMENT_HEADER_TABLE}[0].MasterAirWaybill`,
//       null
//     ),
//     shipmentDate: await getShipmentDate(
//       get(
//         data,
//         `${process.env.SHIPMENT_HEADER_TABLE}[0].ShipmentDateTime`,
//         null
//       )
//     ),
//     handlingStation: get(
//       data,
//       `${process.env.SHIPMENT_HEADER_TABLE}[0].HandlingStation`,
//       null
//     ),
//     originPort: get(
//       data,
//       `${process.env.SHIPMENT_HEADER_TABLE}[0].OrgAirport`,
//       null
//     ),
//     destinationPort: get(
//       data,
...
//     actualWeight: await actualWeight(
//       get(data, `${process.env.SHIPMENT_DESC_TABLE}`, null)
//     ),
//     chargeableWeight: await ChargableWeight(
//       get(data, `${process.env.SHIPMENT_DESC_TABLE}`, null)
//     ),
//     weightUOM: await weightUOM(
//       get(data, `${process.env.SHIPMENT_DESC_TABLE}[0].WeightDimension`, null)
//     ),
...
//     serviceLevelCode: get(
//       data,
//       `${process.env.SHIPMENT_HEADER_TABLE}[0].FK_ServiceLevelId`,
//       null
//     ),
//     serviceLevelDescription: get(
//       data,
//       `${process.env.SERVICE_LEVEL_TABLE}[0].ServiceLevel`,
//       null
//     ),

//     refParty: await refParty(
//       get(data, `${process.env.REFERENCE_TABLE}[0].CustomerType`, null)
//     ),
...
//     locations: await locationFunc(
//       get(data, `${process.env.SHIPMENT_HEADER_TABLE}[0].PK_OrderNo`, null),
//       get(data, `${process.env.SHIPMENT_HEADER_TABLE}[0].Housebill`, null)
//     ),
//     EventDateTime: get(
//       data,
//       `${process.env.SHIPMENT_MILESTONE_TABLE}[0].EventDateTime`,
//       null
//     ),
//     statusCode: get(
//       data,
...
//       data,
//       `${process.env.MILESTONE_TABLE}[0].Description`,
//       null
//     ),
