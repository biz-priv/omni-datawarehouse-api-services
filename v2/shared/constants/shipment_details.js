...
const tableValues = [
    ...
    { tableName: process.env.SHIPMENT_HEADER_TABLE, pKey: "PK_OrderNo", getValues: "PK_OrderNo, Housebill, MasterAirWaybill, ShipmentDateTime, HandlingStation, OrgAirport, DestAirport, ETADateTime, ScheduledDateTime, PODDateTime, PODName, FK_ServiceLevelId, OrderDate", sortName: "shipmentHeader"},  // added get values random, need to be recheck
  ];
const INDEX_VALUES = {
    TRACKING_NOTES: {
