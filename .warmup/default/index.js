...
const functions = [
  {
    "name": "omni-dw-api-services-shipment-info-dev",
    "config": {
      "enabled": true,
      "alias": "v201",
  ...
  {
    "name": "omni-dw-api-services-shipment-detail-dev",
    "config": {
      "enabled": true,
      "alias": "v201",
      "payload": "{\"source\":\"serverless-plugin-warmup\"}",
  ...
  {
    "name": "omni-dw-api-services-invoice-detail-dev",
    "config": {
      "enabled": true,
      "alias": "v201",
      "payload": "{\"source\":\"serverless-plugin-warmup\"}",
  ...
  {
    "name": "omni-dw-api-services-create-shipment-dev",
    "config": {
      "enabled": true,
      "alias": "v201",
      "payload": "{\"source\":\"serverless-plugin-warmup\"}",
  ...
  {
    "name": "omni-dw-api-services-bill-of-lading-dev",
    "config": {
      "enabled": true,
      "alias": "v201",
      "payload": "{\"source\":\"serverless-plugin-warmup\"}",
  ...
  {
    "name": "omni-dw-api-services-upload-pod-document-dev",
    "config": {
      "enabled": true,
      "alias": "v201",
      "payload": "{\"source\":\"serverless-plugin-warmup\"}",
  ...
  {
    "name": "omni-dw-api-services-shipment-rate-dev",
    "config": {
      "enabled": true,
      "alias": "v201",
      "payload": "{\"source\":\"serverless-plugin-warmup\"}",
  ...
  {
    "name": "omni-dw-api-services-shipment-create-dev",
    "config": {
      "enabled": true,
      "alias": "v201",
      "payload": "{\"source\":\"serverless-plugin-warmup\"}",
